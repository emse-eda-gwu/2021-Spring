...
<i class="fas fa-phone"></i> +1 (202) 994-7173 | <i class="far fa-calendar-alt"></i> Jan. 12 - Apr. 27, 2020
...
----|---------------|-------------------------------
Low      | Frequently absent | Rude; disruptive; distracting; monopolizes discussions; rarely participates during in-class problem solving
...
Reflections                   | 12 %   | Weekly assignment (12 x 1%)
Quizzes                       | 15 %   | 5 quizzes; lowest grade dropped
Mini Project 1                | 8 %    |
Mini Project 2                | 8 %    |
Mini Project 3                | 8 %    |
...
df <- data.frame(
    category = c(
      'Att. &\nPart.', 'Reflections', 'Quizzes', 'Mini Projects', 
      'Final Project'),
    percent = c(6, 12, 15, 24, 43)) %>%
...
ggplot(df) +
    # geom_col(aes(x = percent, y = fct_reorder(category, percent)),
    #          width = 0.7, alpha = 0.8) +
