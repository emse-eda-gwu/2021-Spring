...
All course communication will be managed through [Slack](https://emse-eda-s20.slack.com). A link to sign up for the course slack page can be found on the one (and only) announcement on Blackboard.
