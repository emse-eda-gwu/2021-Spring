...
.leftcol[
```{r milk-lollipop-mean, echo=FALSE, fig.height=6.3, fig.width=5, fig.align='center'}
...
.rightcol[
```{r milk-bars-diverging, echo=FALSE, fig.height=6.3, fig.width=5, fig.align='center'}
...
.rightcol[
```{r diamonds-facet-ncol-2, ref.label='diamonds-facet-ncol', echo=FALSE, fig.height=8, fig.width=8, fig.align='center'}
```
]
...
.rightcol[
## Faceting
```{r diamonds-facet-ncol-2, ref.label='diamonds-facet-ncol', echo=FALSE, fig.height=6, fig.width=6, fig.align='center'}
```
]
...
## .center[When comparing **only 2** things,<br>dodged bars are a good starting point<br>...and facets can be helpful]
...
## When comparing **only 2** things,<br>"bullet" charts are also effective
...
```{r milk-compare-dodged-toomany, echo=FALSE, fig.height=5, fig.width=7, fig.align='center'}
...
```{r milk-dumbbell-chart, echo=FALSE, fig.height=6, fig.width=6, fig.align='center'}
...
.leftcol[.code70[
Insert lines - note the `group` variable:
...
```{r federal-spending-dumbbell, echo=FALSE, fig.height=6, fig.width=6, fig.align='center'}
...
.rightcol[
```{r federal-spending-slope, echo=FALSE, fig.height=6, fig.width=6, fig.align='center'}
federal_spending %>%
    filter(year %in% c(1976, 2017)) %>%
    mutate(
      rd_budget_bil = rd_budget_mil / 10^3,
