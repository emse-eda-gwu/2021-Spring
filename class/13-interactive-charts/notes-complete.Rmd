...
Make the static measles heatmap:

```{r measles_heatmap, fig.height=7, fig.width=8, fig.align='center', echo=FALSE}
measles_heatmap <- us_diseases %>%
  filter(
    disease == 'Measles',
  ...
  labs(
    ...
    title = 'Measles cases in the U.S.')
