...
## Meet your learning assistant (LA)!
...
If you're having trouble installing R or RStudio, don't worry - you can quickly launch a _cloud_ version of RStudio in your web browser! Click on the <i class="fab fa-r-project"></i> logo under the "Tools" menu and log in with your GWU web ID and password.
