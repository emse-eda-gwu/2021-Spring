...
3. **Optional Show and Tell**: If you've seen a particularly _good_ or _bad_ visualization that you'd like to share, add it to your reflection. You can insert it as an image, or just link to it. If there is time, I may choose some to use for a "show and tell" in class.
