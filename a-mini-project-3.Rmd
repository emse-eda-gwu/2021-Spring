...
>
> **Assessment**: I will use [this rubric](projects/mini-project-3/rubric.pdf) to grade your submissions.
...
## 6. Search for answers and make charts

For **each** of your questions: 

1. If necessary, modify and / or join together the data frames to address your question. 
2. Compute summary measures (e.g. counts, centrality, variability, correlation) and create some simple summary charts (e.g. histogram, boxplot, scatterplot, etc.) using the variables relevant to your question. These are not "polished" charts but rather charts to help you see and understand key trends or relationships related to your research question. 
3. Create a "polished" chart that highlights a key point related to your research question. It can be any chart type you wish, but it should be carefully chosen to convey a clear message. 
4. Write a paragraph describing what you found. Describe the key message you intended to convey with your chart and note some of the design choices you made to emphasize that point.
