...
Read through [this tutorial](https://towardsdatascience.com/beginners-guide-to-creating-an-r-shiny-app-1664387d95b3). In the template you downloaded for today's reflection, there are blank .R files that you can fill out to follow along and create the shiny app shown in the article on your own computer.
